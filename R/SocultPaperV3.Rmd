...
Several modified Acitive Inference POMPDs were tested against a range-bounded strategy. This was done to test to benchmark the perfomance of POMPDs against a strategy inspired by treatement protocol used in the pilot clinical trial [@zhang2017]
