...
Dotted vertical lines indicated the timepoint for which the evaluation of expected states are extracted. The POMPD seems more inclined to test during treatment, which would sense there would probably more information to be gained.
...
## FEP components can besued to balance testing and treating
