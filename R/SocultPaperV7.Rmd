...
```{r sim lengths, fig.cap= "Simulated observed patient survival times for each POMPD agent and the range-bounded strategy."}
#print densities
...
```{r constrasts, fig.cap="Change in percent of between the range-bound approach and the longest horizon POMPD for different tumor growth rates."}
...
```{r sim params, fig.cap= "Table of Simulation parameters used. R correponds to specific resistance States and T to specific tumor states. For example \"T2 Chance of Resistance Decrease\" denotes the probability of the resistance state decreasing given that the resistance state was 2 (and treatment was applied)."}
