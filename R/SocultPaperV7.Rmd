...
toc: true
abstract: \doublespacing Cancer remains a leading cause of death globally, with drug resistance
...
model is specified by factorizing the joint probability). Solving
[@smith2022]. [^1]
...
round of treating, but models in inspired in AI could carefully and
quantitatively balance information gathering against other objective
measures such as drug toxicity, patient well-being, emergence of
...
# Appendix C: A Dissection of Decision-making by POMPD
