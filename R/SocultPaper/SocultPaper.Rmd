...
Both the resistance state, and tumor states start at state 0 out of 5, meaning that a total is six states are possible in each. Two slightly different simulations are used:
...
Dotted vertical lines indicated the timepoint for which the evaluation of exepected states are extracted.
